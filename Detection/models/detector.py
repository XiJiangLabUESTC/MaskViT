...
class Detector(nn.Module):
    ...
    def forward(self, samples: NestedTensor, mask=None,mask_rate=0.5,mask_layer=9):
        # import pdb;pdb.set_trace()
        ...
        if mask is None:
            ...
            x = self.backbone.forward_features_with_mask(samples.tensor,mask_rate,mask_layer,mask)
